...
$styles = Invoke-WebRequest -UseBasicParsing -Uri "$baseUrl/styles.css?v=20260404d" -TimeoutSec 10
$app = Invoke-WebRequest -UseBasicParsing -Uri "$baseUrl/app.js?v=20260404d" -TimeoutSec 10
...
Assert-True ($index.Content -match "PhoneFarm Dashboard v20260404d") "Dashboard HTML does not contain the expected build string."
